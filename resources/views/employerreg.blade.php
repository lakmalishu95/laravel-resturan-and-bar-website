                ...
                <div class="col-lg-4 align-self-center">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>Here Employers can Register and Join with us.</h6>
                ...
                <div class="col-lg-8">
                    <div class="contact-form">
                        <form style="background-color: none;" id="contact"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4>EMPLOYER  &nbsp;REGISTATION</h4>
                                </div>
                                <div class="col-lg-12 col-sm-12">
                                    <fieldset>
                                        <input name="fname" type="text" id="fname" placeholder="Business type :" required="">
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <fieldset>
                                        <input name="phone" type="number" id="lname" placeholder="Years in Business:" required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12 col-sm-12">
                                    <fieldset>
                                        <input name="phone" type="number" id="lname" placeholder="Resturant/Bar :" required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12 col-sm-12">
                                    <fieldset>
                                        <input name="bname" type="text" id="bname" placeholder="Location :" required="">
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <input type="text" name="category" placeholder="Food/Bar  ?  :">
