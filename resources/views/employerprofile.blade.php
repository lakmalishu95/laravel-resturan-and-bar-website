...
<body >
    ...
    <div class="section" id="chefs" >
        <div class="container">
            ...
            <button class="btn btn-primary"><a style="color: white;" href="{{ url('/employers')}}">< Employers</a></button><br><br>
                ...
                <div class="col-lg-6">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src= "assets/images/chefs-02.jpg"  alt="employee profile image">
                        </div>
