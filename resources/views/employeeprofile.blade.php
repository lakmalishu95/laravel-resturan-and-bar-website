...
<body >
    ...
    <div class="section" id="chefs"  >
        <div class="container">
            ...
            <button class="btn btn-primary"><a style="color: white;" href="{{ url('/employees')}}">< Employees</a></button><br><br>
            ...
            <div class="row" style="padding-bottom: 50px;"> 
                ...
                <div class="col-lg-6">
                            ...
                            <h5>Licence and qualifications : {{$data->emp_licen}} </h5><br>
                            <h5 style="color: blue;">Location : {{$data->emp_location}} </h5><br>
                            <h5>experience : {{$data->emp_d1}}</h5><br>
                            <h5 style="color: blue;">references : {{$data->emp_referances}} </h5><br>
                            ...
                            <form style="margin-left: 0px;"  action="{{url('/employeerev',$data->id)}}" method="post" enctype="multipart/form-data">
                            @csrf    
