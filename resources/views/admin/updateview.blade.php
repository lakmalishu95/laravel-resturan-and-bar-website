                            ...
                            <div class="card-body">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <input style="color: white;" type="text" name="title" class="form-control"  value="{{$data->title}}" required>
                                        </div>
                                    </div>                  
                                    <div class="form-group row">
                                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Price</label>
                                        <div class="col-sm-9">
                                        <input style="color: white;" type="text" class="form-control" name="price" value="{{$data->price}}" required>
                                        </div>
                                    </div>                   
                                    <div class="form-group row">
